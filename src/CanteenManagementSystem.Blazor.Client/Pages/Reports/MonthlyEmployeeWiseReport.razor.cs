...
public partial class MonthlyEmployeeWiseReport
{
    ...
    {
        var url = $"/api/app/reports/excel/monthly-employee-wise?from={Filter.From:yyyy-MM-dd}&to={Filter.To:yyyy-MM-dd}";
    ...
    protected void ExportCsv()
    {
        ...
        DownloadCsv(lines.ToString(), $"monthly-employee-wise-{Filter.From:yyyyMM}.csv");
    }
