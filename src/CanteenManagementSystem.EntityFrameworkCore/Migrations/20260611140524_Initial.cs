    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCanteenCheckIns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastProcessedValue = table.Column<long>(type: "bigint", nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSyncStates", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCanteenCheckIns_CheckInTime",
                table: "AppCanteenCheckIns",
                column: "CheckInTime");

            migrationBuilder.CreateIndex(
                name: "IX_AppCanteenCheckIns_EmployeeId_DeviceId_CheckInTime",
                table: "AppCanteenCheckIns",
                columns: new[] { "EmployeeId", "DeviceId", "CheckInTime" },
                unique: true);
