...
public class CanteenManagementSystemDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<CanteenManagementSystemDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<CanteenManagementSystemResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/CanteenManagementSystem");

            options.DefaultResourceType = typeof(CanteenManagementSystemResource);
        ...
        {
            options.MapCodeNamespace("CanteenManagementSystem", typeof(CanteenManagementSystemResource));
        });
    }
}
